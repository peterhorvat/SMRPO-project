...
from .stories import StoriesApi, StoriesConfirmApi, StoriesRejectApi, StoriesTimeEstimateApi
...
urlpatterns = [
    ...
    path('projects/<int:project_id>/stories/<int:story_id>/time/', StoriesTimeEstimateApi.as_view()),
