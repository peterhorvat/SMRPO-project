# Generated by Django 4.0.2 on 2022-05-02 13:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ure', models.IntegerField(default=0, verbose_name='Ure')),
                ('presoja', models.IntegerField(default=0, verbose_name='Končna presoja')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('clan', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='website.clan', verbose_name='Član')),
                ('naloga', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='website.naloga', verbose_name='Naloga')),
                ('sprint', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='website.sprint', verbose_name='Sprint')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('clan', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='website.clan', verbose_name='Clan')),
                ('naloga', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='website.naloga', verbose_name='Naloge')),
                ('sprint', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='website.sprint', verbose_name='Sprint')),
            ],
            options={
